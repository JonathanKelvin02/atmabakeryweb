...
import LaporanPemasukanPengeluaran from '../../PDF/LaporanPemasukanPengeluaranPDF';
import './LaporanPresensiModal.css';

import { OGetLaporanPemasukanPengeluaran } from '../../../api/apiLaporan';

const LaporanPemasukanPengeluaranModal = ({ show, onClose }) => {
    ...
    const generetingDataToPDF = () => {
        if (selectedMonth === '' || selectedYear === '') {
            ...
            setIsLoading(true);
            OGetLaporanPemasukanPengeluaran(toData).then((res) => {
                setData(res);
                setIsLoading(false);
                setShowPDF(true);
...
export default LaporanPemasukanPengeluaranModal;