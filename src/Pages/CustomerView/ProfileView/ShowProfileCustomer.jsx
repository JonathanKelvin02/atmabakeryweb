...
const ShowProfileCustomer = () => {
  ...
  const updateProfile = (event) => {
    event.preventDefault();
    UpdateProfile(data, data.ID_Customer)
      .then((response) => {
    ...
    <Container>
      {loading || data.length == 0 ? (
        <Col>
          ...
          <Row>
            <p className="d-flex justify-content-center align-item-center mt-3">
              <b>Loading...</b>
            </p>
          </Row>
        </Col>
        ...
        <Row>
          <Col md={6}>
            <div
              className="img-preview text-center position-relative mb-3 me-3"
