...
const CreateTransaksiBahan = ({ onSuccess }) => {
    ...
    const submitData = (event) => {
        ...
        const requestData = {
            ...
            bahanbaku: listBahan.map(item => ({
                ID_Bahan_Baku: item.ID_Bahan_Baku,
                Kuantitas: parseInt(item.Kuantitas), // Pastikan Kuantitas dalam bentuk angka
                Sub_Total: parseInt(item.Sub_Total) // Pastikan Sub_Total dalam bentuk angka
            }))
        };
    
        
        CreateTransBahan(requestData)
            .then((response) => {
                setIsPending(false);
    ...
    return (
        <>
            <button className="add-product border-0" onClick={handleShow}>
                        ...
                        bahanBaku?.length > 0 ? (
                            <Modal.Body>
                                <Form.Group className="mb-3" controlId="formTanggal">
                                    ...
                                    <Form.Control type="date" placeholder="Masukkan Tanggal Pasok" name="Tanggal" onChange={handleChange} required/>
                                </Form.Group>
...
export default CreateTransaksiBahan;